...
function computerPlay () {
    let randomNumber = Math.round(Math.random()*(3-1)) + 1; //Generates randon number between 1 and 3 and rounds
    let selection;
    if (randomNumber === 1) {
        selection = "rock";
...
function game () {
    ...
    for (let i=0; i < 5; i++) {
        ...
        let result = singleRound(computerSelection,prompt("Pick between rock/paper/scissors", "rock" ));
        console.log(result);
